...
public class Album extends MediaObject {
  ...
  //@Override protected void onContextSet(Context context) {
  //  mainColors = new int[] {
  //      context.getResources().getColor(
  //          !Options.isLightTheme() ? R.color.greyDark : R.color.greyLight),
  //      context.getResources().getColor(
  //          !Options.isLightTheme() ? R.color.primary_text_default_material_dark
  //              : R.color.primary_text_default_material_light), context.getResources().getColor(
  //      !Options.isLightTheme() ? R.color.secondary_text_default_material_dark
